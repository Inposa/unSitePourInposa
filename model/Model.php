...
class Model {
	...
	try {
		...
		$sql_suite= $sql_suite.$key."=:tag_$index,";
		$index++;
	    }
	    rtrim($sql_suite,','); //On retire à la chaîne la virgule de trop;
	    
	    $sql_suite=$sql_suite."WHERE $primary_key=:tag_id";
	    $sql = $sql.$sql_suite;
	    ...
	    /*
		"tag_immat" => $data['immatriculation'],
		"tag_marq" => $data['marque'],
		"tag_coul" => $data['couleur'],
	    */
